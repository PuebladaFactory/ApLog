...
@Component({
  selector: 'app-listado-nuevo-proveedor',
  standalone: false,  
  templateUrl: './listado-nuevo-proveedor.component.html',
  styleUrl: './listado-nuevo-proveedor.component.scss'
})
export class ListadoNuevoProveedorComponent implements OnInit, OnDestroy{
