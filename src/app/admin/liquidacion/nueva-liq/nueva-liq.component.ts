...
@Component({
  selector: 'app-nueva-liq',
  standalone:false, 
  templateUrl: './nueva-liq.component.html',
  styleUrl: './nueva-liq.component.scss'
})
export class NuevaLiqComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.compInformeLiquidacion = this.llamadaOrigen === 'cliente' ? 'informesLiquidacionesCl' : this.llamadaOrigen === 'chofer' ? 'informesLiquidacionesCh' : 'informesLiquidacionesPr';    
              ...
              Swal.fire({
                ...
                if (result.isConfirmed) {  
                  switch (this.llamadaOrigen){
                    case 'cliente':
                      if(titulo === "excel"){
                        this.excelServ.exportToExcelCliente(this.informeDeLiquidacion, this.informesLiquidados, this.clientes, this.choferes, accion);
                      }else if (titulo === "pdf"){
                        this.pdfServ.exportToPdfCliente(this.informeDeLiquidacion, this.informesLiquidados, this.clientes, this.choferes, accion);        
                      }
                      break;
                    case 'chofer':
                      if(titulo === "excel"){
                        this.excelServ.exportToExcelChofer(this.informeDeLiquidacion, this.informesLiquidados, this.clientes, this.choferes, accion);
                      }else if (titulo === "pdf"){
                        this.pdfServ.exportToPdfChofer(this.informeDeLiquidacion, this.informesLiquidados, this.clientes, this.choferes, accion);        
                      } 
                      break;
                    case 'proveedor':
                      if(titulo === "excel"){
                          this.excelServ.exportToExcelProveedor(this.informeDeLiquidacion, this.informesLiquidados, this.clientes, this.choferes, accion);
                        }else if (titulo === "pdf"){          
                          this.pdfServ.exportToPdfProveedor(this.informeDeLiquidacion, this.informesLiquidados, this.clientes, this.choferes, accion);
                      }
                      break;  
                    default:
