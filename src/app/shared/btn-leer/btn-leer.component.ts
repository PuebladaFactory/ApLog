...
@Component({
  ...
  <button *ngIf="name === 'print'" class="btn btn-light m-0">
  ...
  <button *ngIf="name === 'tarifa'" class="btn btn-outline-secondary">
      Tarifa Nueva
  </button>
  
    <button *ngIf="name === 'Vehiculos'"  class="btn btn-light m-0" style="border-radius: 10%;  margin: 10px;" >
